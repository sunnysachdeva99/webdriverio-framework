...
describe.skip('Suite 2 ==> Test homepage', () => {
    ...
    describe('Suite 2 ==> nested describle - test homepage', function () {
        ...
        it.skip('Suite 2 ==> verify header "flexible" ', () => {
            var txt = $("//*[@id='tag']/em[text()='flexible']").getText();
            expect(txt).equal('flexible');
            console.log('::: FLEXIBLE :::');
        });
...
describe.skip('Suite 3 ==> Test homepage', () => {
    ...
    describe.skip('suite 3 ==> nested describle - test homepage', function () {
        it('verify title', () => {
            expect(browser.getUrl()).equal('https://mochajs.org/');
